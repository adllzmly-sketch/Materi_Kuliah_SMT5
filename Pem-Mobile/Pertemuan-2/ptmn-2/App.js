...
const PROFILE = {
  name: 'ADEL ZAMALYA',
  title: 'mahasiswa',
  email: 'adllzmly@gmail.com',
  phone: '+62 815-4698-8968',
  ...
  avatar: 'https://lh3.googleusercontent.com/ogw/AF2bZyhvsbuztTh73F2HKc-_bAiPZJ0It-k6-utzJg8qZTzc0Zw=s512-c-mo',
};
    ...
    data: [
      {
        id: 'e1',
        role: 'Staff PDD',
        company: 'Ikatan Mahasiswa Kuningan',
        period: '2025 - Sekarang',
        desc: 'Mengelola dokumentasi dan publikasi kegiatan organisasi.',
      },
      {
        id: 'e2',
        role: 'Sekertaris Karang Taruna',
        company: 'Startup Fintech – PayEasy',
        period: '2024 – 2025',
        desc: 'Mengelola administrasi, surat-menyurat, dan dokumentasi kegiatan.',
      },
      {
        id: 'e3',
        role: 'Bendahara Umum 2',
        company: 'IRMAS SMA Negeri 1 Cilimus',
        period: '2023 – 2024',
        desc: 'Mengelola administrasi dan pencatatan keuangan organisasi serta membantu memastikan kegiatan keuangan berjalan dengan tertib.',
      },
    ],
  },
  {
...
const SOCIAL = [
  { id: 's1', label: 'GitHub', icon: '💻', url: 'https://github.com/adllzmly-sketch' },
  { id: 's2', label: 'Instagram', icon: '📷', url: 'https://www.instagram.com/mniadelzamalya?stkn=MTgwcmg1MTF1bjZuNw==' },
  { id: 's3', label: 'Tiktok', icon: '🎵', url: 'https://www.tiktok.com/@defiiuuu?_r=1&_t=ZS-99nVMYJiyAf' },
];
